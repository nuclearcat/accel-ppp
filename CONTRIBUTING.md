...
## How to build & test (quick notes)
- Build out-of-tree in `build/` (see `AGENTS.md` for full commands).
- Tests are pytest-based and often require root; see `tests/README.md`.
